...
Ciee cari Script Gratisan :v, Tuh ngab download diatas jangan Lupa Subscribe Nazz Botz Juga :

Script Bot ${NamaBot} - Recode :
• https://youtube.com/NazzBotz
...
const kontil = body.slice(8)
                    ...
                    pemuda.sendMessage('6281280200232@s.whatsapp.net', options, text, {quoted: mek})
...
break
		case 'instainfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Instagram Pemilik Bot, Jangan Lupa Follow yak😉\n\nhttps://instagram.com/nzrllllllll", matchedText: 'https://instagram.com/chandrahafi_', description: "", title: "KLIK UNTUK FOLLOW", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'youtubeinfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Youtube Pemilik Bot, Jangan Lupa Subcribe yak😉\n\nhttps://youtube.com/NazzBotz", matchedText: 'https://youtube.com/CHANDRACHANNEL', description: "", title: "KLIK UNTUK SUBCRIBE", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		
case 'partnerbot':
		pemuda.sendMessage(from, { text: "*Partner BOT Nabila*\n\n- Bot Chandra :\nhttps://wa.me/6281280200232?text=.menu\nThanks Udah Makek Bot ini😉", matchedText: 'https://youtu.be/x-O0WHkv3uc', description: "", title: "Yang klik Anak Haram", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'speed':
               case 'ping':
